...
" Change shell
set shell=zsh                  " Vim expects a POSIX-compliant shell, which Fish (my default shell) is not
...
set foldcolumn=0 " Disable folding initially
...
" Map CTL + s to save current document
:nmap <C-s> :w<CR>
:imap <C-s> <Esc>:w<CR>

" Map CTL + q to quick current document
